...
void main() {
  ...
  test('TF-01: Agregar tarea con nombre y experiencia', () {
    final tarea = Tarea(
      id: '1',
  ...
  test('TF-02: Crear nueva categoría y verificar categorías predeterminadas', () {
    // Categorías predeterminadas
    expect(service.categorias, containsAll(['Caminata', 'Natación', 'Levantamiento de peso']));
  ...
  test('TF-03: Completar tarea con imagen asignada', () {
    final tarea = Tarea(
      id: '2',
      nombre: 'Bicicleta',
      categoria: 'Cardio',
  ...
  test('TF-04: Editar tarea actualiza datos', () {
    final tarea = Tarea(
      id: '3',
      nombre: 'Correr',
      categoria: 'Cardio',
  ...
  test('TF-04: Eliminar tarea la mueve al historial', () {
    final tarea = Tarea(
      id: '4',
      nombre: 'Remo',
      categoria: 'Fuerza',
  ...
  test('TF-05: Ingresar apodo sin autenticación', () {
    service.setApodo('Alfredo');
    expect(service.apodo, 'Alfredo');
  });

  test('TF-07: Registrar hora creación y finalización en tarea', () {
